...
def test_get_bestellartikel_not_found(lambda_context, dynamodb_table):
    pathParameters = {
        "id": "unknown_id"
    }
...
def test_get_bestellartikel_ok(lambda_context, dynamodb_table):
    item = {
        'bezeichnung': "Rotwein",
        "preisInEuro": 5.21,
        "gruppe": "Wein"
...
def test_get_bestellartikel_without_tenant_id_not_ok(lambda_context, dynamodb_table):
    headers = {
